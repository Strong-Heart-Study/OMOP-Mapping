...
join (
	...
	, 'S4ETOH'
	, 'S4ACR'
	--, 'S4ACR2' (same information as in S5ACR. present only for Phase 4 & 5)
	, 'S4SMOKE'
	, 'S4KD'
		)
...
update mg set obs_date =   rw.S4EXDATE 
, Phase = 'Phase IV' 
, value_as_string = case 
		...
		--when obs_name like '__ACR2' and obs_value = 'N' Then 'NORMAL (URINARY ALBUMIN/
