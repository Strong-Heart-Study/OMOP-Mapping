...
*********************************************************************/
	...
	, year(S4EXDATE) - S4AGE as year_of_birth
	, 1 as month_of_birth
	, 1 as day_of_birth
	, cast((year(S4EXDATE) - S4AGE) as varchar(20)) as birth_datetime
	...
	from omoprawdata.[dbo].[S4ALL23] pat --raw source data
	left omop1.dbo.person p1 on p1.person_id = pat.idno
