...
, pat.S5EXDATE as visit_start_date
, pat.S5EXDATE as visit_start_datetime
, pat.S5EXDATE as visit_end_date
, pat.S5EXDATE as visit_end_datetime
, vt.concept_id as visit_type_concept_id 
, NULL as provider_id 
, cs.care_site_id as care_site_id
, 'SHS Phase V ' + cast(pat.S5EXDATE as varchar(20)) as visit_source_value 
...
where pat.S5EXDATE is not null 
