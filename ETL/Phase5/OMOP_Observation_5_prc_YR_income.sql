...
select idno, s5exdate obs_date, 'Phase V' Phase
, S5INCOME as obs_value,  'S5INCOME' as obs_name
, value_as_string = case 
		when S5INCOME = '1' then '<5000'
		when S5INCOME = '2' then '5001 - 10000' 
		when S5INCOME = '3' then '10001 - 15000' 
		when S5INCOME = '4' then '15001 - 20000'

		when S5INCOME = '5' then '20001 - 25000' 
		when S5INCOME = '6' then '25001 - 35000' 
		when S5INCOME = '7' then '35001 - 50000' 
		when S5INCOME = '8' then 'over 50000'

		when S5INCOME = '9' then 'Don''t know/not sure'
		when S5INCOME = '0' then 'Refused'

	end
into #obs
 from  [omoprawdata].dbo.S5ALL23 rw 
