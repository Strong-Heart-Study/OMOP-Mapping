...
from (
	...
	, 'S5EDU'								as measurement_source_value
	, pat.S5EDU								as measurement_value
	...
	left join omop1.dbo.source_to_concept_map shs1 on shs1.source_code= 'S5EDU'
	where pat.S5EDU is not null 
