...
-- Description: ETL to map LT_AAR and RT_AAR information from SHSALL (phase5) to OMOP Measurement table
...
---------		-----------	------------	-------------			--------		-------		--------------------	------------------------
S5RT_AAR		46237026		77194-9		Ankle-brachial index	Measurement		LOINC		45881626				Right
S5LT_AAR		46237026		77194-9		Ankle-brachial index	Measurement		LOINC		45883143				Left
...
--S5RT_AAR		46237026		77194-9		Ankle-brachial index
select 'S5RT_AAR', 0, 'SHS', 46237026, 'SNOMED', '1996-09-08',	'2099-12-31' union all -- condition mapping (standard concept)
select 'S5LT_AAR', 0, 'SHS', 46237026, 'SNOMED', '1996-09-08',	'2099-12-31'  -- condition mapping (standard concept)


-----------------------------------------------

---- Insert SHS Phase 5 Labs data 
